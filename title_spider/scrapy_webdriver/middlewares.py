...
class WebdriverSpiderMiddleware(object):
    ...
    def process_start_requests(self, start_requests, spider):
        ...
        """
        return self.process_requests(start_requests, start=True)
    ...
    def process_spider_output(self, response, result, spider):
        ...
        """
        for item_or_request in self.process_requests(result):
    ...
    def process_requests(self, items_or_requests, start=False):
